...
//my declare
  ...
  void  SetSlow_StartAlgo (Slow_StartAlgo_t ssalgo);
  void  SetSlow_StartSubflowAlgo (Slow_StartSubflowAlgo_t llalgo);
  void InitialRtt(uint16_t i); 
  void SetBottleneckBandwidth (uint32_t Bandwidth);
...
protected:
  ...
  Slow_StartAlgo_t  m_algoSS;
  Slow_StartSubflowAlgo_t  m_algoLL;
  ...
  double    SlowStartCtrol(uint8_t sFlowIdx);
