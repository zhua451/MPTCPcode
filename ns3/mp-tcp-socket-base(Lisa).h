...
//my declare
void setSocketNum(uint32_t i);
 uint32_t socketNum;
uint32_t getSocketNum();
  double  ThroughPut(uint32_t i);
void ModelTest0Drop();
void ModelTest0Drop4();
void ModelTest0Drop5();
void ModelTest0Drop6();
void ModelTest0Drop7();
void ModelTest0Drop8();
void ModelTest0Drop9();
void ModelTest0Drop10();
void ModelTest0Drop12();
void ModelTest0Drop14();
void ModelTest0Drop18();
void ModelTest0Drop20();
void ModelTest0Drop21();
void ModelTest001Drop();
void ModelTest002Drop();
void ModelTest004Drop();
void ModelTest005Drop();
void ModelTest010Drop();
void ModelTest003Drop();
void ModelTest008Drop();
void ModelTest01Drop();
void lisaCwnd(uint32_t sFlowIdx);
  double  TotalData(int n,uint32_t sFlowIdx,double cwnd,uint32_t sst,double p,double p0,int flag);
void printMes(int signo)  ;
int printCwnd() ;
void setDiscreteRatio(uint8_t discreteRatio);
void setFileSize(uint32_t size); 
double getFileSize();
 void InitialRtt();  
  void    SortRtt();
  double fac(uint32_t x);
  void my_calculate_alpha ();
  uint8_t getUseId(double filesize);
...
protected:
  ...
  double myRtt[10];            //rtt of each subflow
  sFlowPart sfp[8];
  uint32_t fs[8];
  double ts[100];
  double totalData;
//set path discreteRatio
  uint8_t dr;
  double filesize;
  double filesize2;
  double filesize3;
  ...
  int timeOut[100];
  int retransmit[100];
  bool isCatch;                //用来判断filesize能否被获取
  int ss_ss;
  int firstUsed[8];
